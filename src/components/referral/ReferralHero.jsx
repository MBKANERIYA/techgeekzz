        ...
        <div className="row align-items-center">
          <div className="col-lg-7">
            <div className="d-inline-flex align-items-center gap-2 rounded-pill px-3 py-2 mb-4" style={{ background: 'rgba(165,0,253,0.1)', border: '1px solid rgba(165,0,253,0.2)' }}>
              ...
              <span style={{ fontSize: '0.78rem', color: '#a500fd', fontWeight: 600 }}>Partner Program</span>
            </div>
            ...
            <p className="text-secondary fs-5 mb-4" style={{ maxWidth: 520, lineHeight: 1.7 }}>
              Join TechGeekz's referral program and earn up to <strong style={{ color: '#a500fd' }}>20% recurring commission</strong> for every client you send our way. No limits. No hassle.
            </p>
