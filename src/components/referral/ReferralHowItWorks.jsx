const steps = [
  { num: "01", title: "Sign Up", desc: "Join our referral program in under 60 seconds — no strings attached.", icon: "" },
    ...
    <section id="how-it-works">
      <div className="container">
        ...
        <div className="text-center mb-5 pt-4">
          <span className="d-inline-block rounded-pill px-3 py-1 mb-3" style={{ background: 'rgba(165,0,253,0.1)', border: '1px solid rgba(165,0,253,0.15)', color: '#a500fd', fontSize: '0.78rem', fontWeight: 600 }}>Simple Process</span>
