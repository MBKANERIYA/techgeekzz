      ...
      <div className="container">
        ...
        <div className="row g-5 align-items-start pt-4">
          ...
          <div className="col-lg-5">
            <span className="d-inline-block rounded-pill px-3 py-1 mb-3" style={{ background: 'rgba(165,0,253,0.1)', border: '1px solid rgba(165,0,253,0.15)', color: '#a500fd', fontSize: '0.78rem', fontWeight: 600 }}>Start Earning</span>
