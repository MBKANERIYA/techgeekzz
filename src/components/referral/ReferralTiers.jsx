const tiers = [
  ...
  },
  {
    ...
    color: "#c084fc",
    bg: "linear-gradient(135deg, rgba(139,92,246,0.18), rgba(192,132,252,0.05))",
    ...
    <section>
      <div className="container">
        ...
        <div className="text-center mb-5 pt-4">
          <span className="d-inline-block rounded-pill px-3 py-1 mb-3" style={{ background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.15)', color: '#c084fc', fontSize: '0.78rem', fontWeight: 600 }}>Earn More, Tier Up</span>
        ...
        <div className="row g-4">
          {tiers.map((tier, i) => (
            <div key={i} className="col-lg-3 col-md-6">
              ...
              >
                {tier.featured && <div className="position-absolute top-0 end-0 rounded-bl-3 px-3 py-1" style={{ background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', fontSize: '0.7rem', fontWeight: 700, color: '#fff' }}>POPULAR</div>}
