const testimonials = [
  ...
  { name: "Priya Sharma", role: "Marketing Consultant", text: "I recommend TechGeekz to my clients anyway — now I get paid for it. The Gold tier perks are amazing.", avatar: "PS" },
