...
const faqs = [
  ...
  { q: "What is the minimum budget to work with TechGeekz?", a: "Every project is different. We offer flexible packages tailored to your goals and budget. Get in touch for a free consultation and custom quote." },
    ...
    <section>
      <div className="container">
        ...
        <div className="text-center mb-5 pt-4">
          <span className="d-inline-block rounded-pill px-3 py-1 mb-3" style={{ background: 'rgba(165,0,253,0.1)', border: '1px solid rgba(165,0,253,0.15)', color: '#a500fd', fontSize: '0.78rem', fontWeight: 600 }}>Common Questions</span>
