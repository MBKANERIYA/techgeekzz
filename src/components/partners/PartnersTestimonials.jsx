const testimonials = [
  { name: "David Park", role: "VP Partnerships, Semrush", text: "TechGeekz is one of our most active agency partners. Their team consistently delivers outstanding results using our platform.", avatar: "DP" },
  { name: "Laura Mitchell", role: "Partner Manager, HubSpot", text: "The collaboration has been seamless. TechGeekz brings strategic depth that elevates how clients use our tools.", avatar: "LM" },
    ...
    <section>
      <div className="container">
        ...
        <div className="text-center mb-5 pt-4">
          <span className="d-inline-block rounded-pill px-3 py-1 mb-3" style={{ background: 'rgba(165,0,253,0.1)', border: '1px solid rgba(165,0,253,0.15)', color: '#a500fd', fontSize: '0.78rem', fontWeight: 600 }}>Partner Voices</span>
            ...
            <div key={i} className="col-lg-4 col-md-6">
              <div className="rounded-4 p-4 h-100 glow-card" style={{ background: '#12121a', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <div className="d-flex align-items-center gap-3">
                  <div className="d-flex align-items-center justify-content-center rounded-circle fw-bold text-white" style={{ width: 40, height: 40, background: '#a500fd', fontSize: '0.8rem', flexShrink: 0 }}>{t.avatar}</div>
                  <div>
