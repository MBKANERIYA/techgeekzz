const benefits = [
  ...
  },
  {
    icon: "📈",
    title: "Co-Marketing",
    description: "Joint case studies, webinars, blog content, and event sponsorships. Amplify your brand alongside NinjaPromo.",
    stat: "50+",
    ...
    <section>
      <div className="container">
        ...
        <div className="text-center mb-5 pt-4">
          <span className="d-inline-block rounded-pill px-3 py-1 mb-3" style={{ background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.15)', color: '#c084fc', fontSize: '0.78rem', fontWeight: 600 }}>Why Partner With Us</span>
            ...
            <div key={i} className="col-lg-4 col-md-6">
              <div className="rounded-4 p-4 h-100 glow-card" style={{ background: '#12121a', border: '1px solid rgba(255,255,255,0.06)' }}>
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <div className="d-flex align-items-center justify-content-center rounded-3" style={{ width: 48, height: 48, background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.2)' }}>
