...
const config = {
  ...
  heroDescription: "Turn more visitors into customers with <strong style='color:#c084fc'>scientific CRO strategies</strong>. We optimize every step of your funnel for measurable revenue growth.",
  stats: [
  ...
  services: [
    ...
    { icon: "🗺️", title: "User Journey Mapping", desc: "Map the complete customer journey and optimize every touchpoint for conversion." },
