...
const WebDesignPage = () => <ServicePageTemplate config={{
  title: "Web Design", icon: "🖥️", badge: "Web Design & Development", glowColor: "rgba(99,102,241,1)",
  heroImage: '/images/heroes/hero-design.png',
  heroTitle: "Stunning", heroHighlight: "Web Design.",
  heroDescription: "Custom websites that combine <strong style='color:#c084fc'>award-winning aesthetics</strong> with conversion-optimized performance to grow your business.",
  stats: [
  ...
  services: [
    { icon: "🖥️", title: "Custom Websites", desc: "Fully custom designs tailored to your brand — no templates." },
