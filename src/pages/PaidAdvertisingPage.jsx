...
const config = {
  ...
  heroDescription: "Drive immediate results with <strong style='color:#c084fc'>high-ROI paid campaigns</strong> across Google, Meta, YouTube, Amazon, and every major ad platform.",
  stats: [
  ...
  services: [
    ...
    { icon: "▶️", title: "YouTube Ads", desc: "Video advertising from pre-rolls to discovery ads for brand awareness and conversions." },
