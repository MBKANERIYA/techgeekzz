...
const config = {
  ...
  heroDescription: "Get a comprehensive digital marketing roadmap that aligns every channel with your <strong style='color:#c084fc'>business objectives</strong> and drives predictable growth.",
  stats: [
  ...
  services: [
    { icon: "🗺️", title: "Go-To-Market Strategy", desc: "Launch plans for new products, markets, and audiences with clear KPIs and timelines." },
