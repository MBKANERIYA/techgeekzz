...
const GoogleAdsPage = () => <ServicePageTemplate config={{
  ...
  heroDescription: "Capture high-intent customers at the exact moment they search with <strong style='color:#c084fc'>expert Google Ads management</strong> that maximizes every dollar.",
  stats: [
  ...
  services: [
    ...
    { icon: "🖼️", title: "Display Network", desc: "Visual banner ads across 2M+ websites for awareness and retargeting." },
