...
const config = {
  ...
  heroDescription: "Transform raw data into <strong style='color:#c084fc'>strategic decisions</strong>. Our analytics experts set up, track, and interpret the metrics that actually matter for your business.",
  stats: [
  ...
  services: [
    ...
    { icon: "🏷️", title: "Tag Management", desc: "Google Tag Manager setup, audit, and optimization for clean, reliable data collection." },
  ...
  process: [
    ...
    { icon: "🏗️", title: "Implementation", desc: "Set up tracking, tags, events, and data layers with precision." },
  ...
  whyUs: [
    ...
    { icon: "⚙️", title: "Platform Agnostic", desc: "GA4, Adobe Analytics, Mixpanel, Amplitude — we work with all major platforms." },
