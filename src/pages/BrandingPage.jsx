...
const BrandingPage = () => <ServicePageTemplate config={{
  ...
  heroDescription: "Create a <strong style='color:#c084fc'>memorable brand identity</strong> that resonates with your audience and sets you apart in a crowded marketplace.",
  stats: [
  ...
  services: [
    { icon: "✏️", title: "Logo Design", desc: "Distinctive logos that capture your essence and stand the test of time." },
