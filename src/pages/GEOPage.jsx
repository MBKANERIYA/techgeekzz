...
const config = {
  title: "GEO", icon: "", badge: "Generative Engine Optimization", glowColor: "rgba(165,0,253,1)",
  heroImage: '/images/heroes/hero-seo.png',
  heroTitle: "Get Found in", heroHighlight: "AI Search.",
  heroDescription: "Optimize your brand for <strong style='color:#a500fd'>AI-powered search engines</strong> like ChatGPT, Perplexity, Google AI Overviews, and the future of search.",
  stats: [
  ...
  services: [
    ...
    { icon: "", title: "AI-Optimized Content", desc: "Content structured for AI comprehension with clear facts, statistics, and authority signals." },
