...
const config = {
  title: "Multilingual SEO", icon: "🗣️", badge: "Multilingual SEO", glowColor: "rgba(34,197,94,1)",
  heroImage: '/images/heroes/hero-seo.png',
  heroTitle: "Speak Your Audience's", heroHighlight: "Language.",
  heroDescription: "Reach global audiences in their native language with <strong style='color:#c084fc'>multilingual SEO</strong> that goes beyond translation to true localization.",
  stats: [
  ...
  services: [
    { icon: "🗣️", title: "Native Keyword Research", desc: "Keyword research by native speakers who understand local search behavior." },
    ...
    { icon: "⚙️", title: "Technical Multilingual Setup", desc: "Hreflang, language selectors, and CMS configuration for multilingual sites." },
  ...
  whyUs: [
    { icon: "🗣️", title: "Native Speakers", desc: "Content created by native speakers in 20+ languages, never machine-translated." },
    { icon: "🌍", title: "Cultural Depth", desc: "We understand cultural nuances that impact search behavior and conversion." },
    { icon: "⚙️", title: "Technical Excellence", desc: "Perfect hreflang implementations and multilingual site architecture." },
