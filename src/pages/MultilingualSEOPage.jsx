...
const faqs = [
  { q: 'What languages do you support?', a: 'We have native speakers for 20+ languages including Spanish, French, German, Portuguese, Chinese, Japanese, Arabic, Korean, Hindi, Italian, Dutch, and more. We continuously expand our language capabilities.' },
  { q: 'Is machine translation okay for SEO?', a: 'No. Machine translation misses cultural nuances, local search intent, and idiomatic expressions. We always use native speakers with SEO training to ensure content resonates with local audiences.' },
  { q: 'How do you handle hreflang implementation?', a: 'We implement proper hreflang tags across all language versions of your site, configure XML sitemaps for each language, and ensure search engines serve the correct version to users in each region.' },
  { q: 'Can you localize our existing content?', a: 'Yes. We audit existing translations, fix SEO issues, and optimize for local keywords rather than literal translations. True localization goes beyond word-for-word translation to cultural adaptation.' },
  { q: 'What CMS do you recommend for multilingual sites?', a: 'It depends on your needs. WordPress with WPML, Webflow with Weglot, or headless CMS solutions all work well. We help you choose and configure the best option for your specific requirements.' },
];



const MultilingualSEOPage = () => {
          ...
          <div className="row align-items-start g-5">
            ...
            <div className="col-lg-7">
              <h1 className="display-4 fw-bold text-white mb-4" style={{ lineHeight: 1.1, letterSpacing: '-1px' }}>
                <span className="hero-gradient-text">Multilingual SEO</span> Services
              </h1>

              <p className="text-secondary mb-4" style={{ maxWidth: 580, lineHeight: 1.8, fontSize: '1rem' }}>
                TechGeekz is one of the best SEO companies, offering expert services to boost your rankings, drive traffic, and grow your online presence. With our Multilingual SEO services, we promise the best conversion rates possible across all search platforms.
              </p>

              <p className="text-secondary mb-5" style={{ maxWidth: 580, lineHeight: 1.8, fontSize: '1rem' }}>
                As a leading <strong className="text-white">Multilingual SEO Company</strong>, TechGeekz brings together an innovation-led approach and search engine-friendly practices to help your website reach and be found by your target users. Our team of <strong className="text-white">Multilingual SEO Experts</strong> ensures that your business gains visibility and drives more customers and ultimately revenue.
              </p>
                  ...
                  <form onSubmit={handleSubmit} className="p-4 p-lg-4">
                    ...
                    <div className="mb-4">
                      ...
                      >
                        ...
                        <option value="multilingual-seo" style={{ background: '#1a1a2e' }}>Multilingual SEO Services</option>
          ...
          <div className="row align-items-center g-5 pt-4">
            ...
            <div className="col-lg-5">
              <div className="rounded-4 p-4 text-center" style={{ background: 'rgba(165,0,253,0.03)' }}>
                <img src="/images/multilingual-seo-illustration.png" alt="Multilingual SEO Services Illustration" className="img-fluid" style={{ maxHeight: 380 }} />
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="text-center mb-5 pt-4">
            <h2 className="display-6 fw-bold text-white" style={{ letterSpacing: '-1px' }}>
              Advantages of our <span className="hero-gradient-text fst-italic">Multilingual SEO services</span>
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: 'With the help of our Multilingual SEO services for small business, your website will rank higher and receive more visitors from search performance. People rarely care to look at Google\'s second-page results, so if your website is on the first page, you will receive clicks and your website will gain more visibility.',
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#a500fd" strokeWidth="1.5">
                ...
                desc: 'Our Multilingual SEO strategies target customers who are actively searching for services in your area. By optimizing your Google Business Profile and local listings, we connect your business directly with high-intent local buyers ready to convert.',
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#a500fd" strokeWidth="1.5">
                ...
                desc: 'Multilingual SEO drives highly targeted traffic that converts at a much higher rate. When customers find your business at the top of local results, they are more likely to call, visit, or make a purchase — directly boosting your revenue and ROI.',
              },
            ].map((card, i) => (
