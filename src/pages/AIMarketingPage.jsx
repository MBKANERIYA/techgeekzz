...
const config = {
  ...
  heroDescription: "Harness the power of <strong style='color:#a500fd'>artificial intelligence</strong> to automate, personalize, and optimize your marketing at unprecedented scale and efficiency.",
  stats: [
  ...
  services: [
    ...
    { icon: "", title: "AI Email Personalization", desc: "Dynamic content, send-time optimization, and subject line generation powered by AI." },
  ...
  process: [
    ...
    { icon: "", title: "Integration & Deployment", desc: "Seamlessly integrate AI tools into your existing marketing workflows." },
  ...
  whyUs: [
    ...
    { icon: "", title: "Custom Solutions", desc: "We build bespoke AI solutions, not just plug-and-play tool setups." },
