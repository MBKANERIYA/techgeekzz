...
const faqs = [
  {
    q: 'What is SEO Audit?',
    a: 'SEO Audit (Search Engine Optimization) is the practice of improving your business\'s website and listings in internet search results for customers in your area. It\'s advantageous for any company that caters to a specific geographic region.',
  },
  {
    q: 'Why is SEO Audit important for my business?',
    a: 'SEO Audit is one of the strongest strategies for boosting traffic from your specific location. If your business depends on organic traffic, SEO Audit services can bring in the highly targeted visitors you\'re looking for, driving more footfall and revenue.',
  },
  {
    q: 'How much does SEO Audit cost?',
    a: 'The cost of SEO Audit varies depending on the specific project scope, competition level, and services required. We offer customized packages to fit different budgets while delivering maximum ROI for your website.',
  },
  {
    q: 'How can SEO Audit help grow my business?',
    a: 'SEO Audit attracts a sizable target audience to your business. The goal is to become the top service provider in your specific area, driving organic traffic and leads that increase sales from customers near your location.',
  },
  {
    q: 'How long does it take to see results?',
    a: 'Results vary depending on your business type and competition level. Some businesses see improvements within the first few weeks, while others may need 2-3 months to see optimal outcomes. SEO Audit generally shows faster results than traditional SEO.',
  },
];
          ...
          <div className="row align-items-start g-5">
            ...
            <div className="col-lg-7">
              <h1 className="display-4 fw-bold text-white mb-4" style={{ lineHeight: 1.1, letterSpacing: '-1px' }}>
                <span className="hero-gradient-text">SEO Audit</span> Services
              </h1>

              <p className="text-secondary mb-4" style={{ maxWidth: 580, lineHeight: 1.8, fontSize: '1rem' }}>
                TechGeekz is one of the best SEO companies, offering expert services to boost your rankings, drive traffic, and grow your online presence. With our SEO Audit services, we promise the best conversion rates possible across all search platforms.
              </p>

              <p className="text-secondary mb-5" style={{ maxWidth: 580, lineHeight: 1.8, fontSize: '1rem' }}>
                As a leading <strong className="text-white">SEO Audit Company</strong>, TechGeekz brings together an innovation-led approach and search engine-friendly practices to help your website reach and be found by your target users. Our team of <strong className="text-white">SEO Audit Experts</strong> ensures that your business gains visibility and drives more customers and ultimately revenue.
              </p>
                  ...
                  <form onSubmit={handleSubmit} className="p-4 p-lg-4">
                    ...
                    <div className="mb-4">
                      ...
                      >
                        ...
                        <option value="seo-audit" style={{ background: '#1a1a2e' }}>SEO Audit Services</option>
          ...
          <div className="row align-items-center g-5 pt-4">
            ...
            <div className="col-lg-5">
              <div className="rounded-4 p-4 text-center" style={{ background: 'rgba(165,0,253,0.03)' }}>
                <img src="/images/seo-audit-illustration.png" alt="SEO Audit Services Illustration" className="img-fluid" style={{ maxHeight: 380 }} />
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="text-center mb-5 pt-4">
            <h2 className="display-6 fw-bold text-white" style={{ letterSpacing: '-1px' }}>
              Advantages of our <span className="hero-gradient-text fst-italic">SEO Audit services</span>
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: 'With the help of our SEO Audit services for small business, your website will rank higher and receive more visitors from search performance. People rarely care to look at Google\'s second-page results, so if your website is on the first page, you will receive clicks and your website will gain more visibility.',
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#a500fd" strokeWidth="1.5">
                ...
                desc: 'Our SEO Audit strategies target customers who are actively searching for services in your area. By optimizing your Google Business Profile and local listings, we connect your business directly with high-intent local buyers ready to convert.',
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#a500fd" strokeWidth="1.5">
                ...
                desc: 'SEO Audit drives highly targeted traffic that converts at a much higher rate. When customers find your business at the top of local results, they are more likely to call, visit, or make a purchase — directly boosting your revenue and ROI.',
              },
            ].map((card, i) => (
