...
const config = {
  ...
  heroDescription: "Turn your email list into a revenue machine with <strong style='color:#c084fc'>personalized campaigns</strong>, automated workflows, and data-driven optimization.",
  stats: [
  ...
  services: [
    ...
    { icon: "✍️", title: "Copywriting & Design", desc: "Conversion-focused copy and pixel-perfect templates that reflect your brand." },
    { icon: "⚙️", title: "Marketing Automation", desc: "Drip campaigns, triggers, and behavioral automation using Klaviyo, HubSpot, and Mailchimp." },
