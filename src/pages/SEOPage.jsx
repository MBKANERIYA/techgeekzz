...
const config = {
  ...
  heroDescription: "Drive organic traffic and outrank competitors with <strong style='color:#a500fd'>data-driven SEO strategies</strong> that deliver sustainable, long-term growth.",
  stats: [
  ...
  services: [
    ...
    { icon: "", title: "Technical SEO", desc: "Site speed, crawlability, indexation, schema markup, and Core Web Vitals optimization." },
    { icon: "", title: "International SEO", desc: "Multi-region strategies with hreflang, geo-targeting, and localized content." },
    { icon: "", title: "Multilingual SEO", desc: "Native-language keyword research, translation optimization, and cultural adaptation." },
