...
const YouTubeAdsPage = () => <ServicePageTemplate config={{
  title: "YouTube Ads", icon: "▶️", badge: "YouTube Advertising", glowColor: "rgba(255,0,0,1)",
  heroImage: '/images/heroes/hero-ads.png',
  heroTitle: "Advertise on", heroHighlight: "YouTube.",
  heroDescription: "Reach 2.5 billion users with <strong style='color:#c084fc'>high-impact video advertising</strong> on the world's second-largest search engine.",
  stats: [
  ...
  services: [
    { icon: "▶️", title: "Skippable In-Stream", desc: "Pre-roll ads that play before videos with the option to skip after 5 seconds." },
    { icon: "⏹️", title: "Non-Skippable Ads", desc: "15-second ads that guarantee your full message is seen." },
    ...
    { icon: "🖼️", title: "Bumper Ads", desc: "6-second non-skippable ads for quick brand awareness." },
