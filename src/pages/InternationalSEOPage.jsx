...
const config = {
  ...
  heroDescription: "Reach new markets with <strong style='color:#c084fc'>international SEO strategies</strong> that adapt your content and technical setup for global search dominance.",
  stats: [
  ...
  services: [
    ...
    { icon: "🗺️", title: "Geo-Targeting Strategy", desc: "ccTLD, subdomain, or subdirectory — we choose the best structure for your goals." },
    ...
    { icon: "⚙️", title: "Technical Setup", desc: "CDN configuration, server location, and international site architecture." },
  ],
  process: [
    { icon: "🔍", title: "Market Analysis", desc: "Identify highest-opportunity markets based on search demand and competition." },
    { icon: "🏗️", title: "Architecture", desc: "Design the optimal international site structure and technical setup." },
  ...
  whyUs: [
    ...
    { icon: "🗣️", title: "Native Speakers", desc: "Content created by native speakers, not machine translated." },
    { icon: "⚙️", title: "Technical Precision", desc: "Flawless hreflang, canonical, and geo-targeting implementations." },
