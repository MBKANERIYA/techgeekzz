...
const config = {
  ...
  heroDescription: "Get found by customers in your area with <strong style='color:#c084fc'>local SEO strategies</strong> that boost your Google Maps visibility and drive foot traffic.",
  stats: [
  ...
  services: [
    ...
    { icon: "🗺️", title: "Local Citations", desc: "NAP consistency across 100+ directories, data aggregators, and industry listings." },
