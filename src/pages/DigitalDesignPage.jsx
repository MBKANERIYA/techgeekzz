...
const DigitalDesignPage = () => <ServicePageTemplate config={{
  ...
  heroDescription: "From stunning websites to cohesive brand identities, our <strong style='color:#c084fc'>design team creates experiences</strong> that look beautiful and drive results.",
  stats: [
  ...
  services: [
    { icon: "🖥️", title: "Web Design", desc: "Custom websites that look stunning, load fast, and convert visitors into customers." },
