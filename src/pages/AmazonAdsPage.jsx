...
const AmazonAdsPage = () => <ServicePageTemplate config={{
  ...
  heroDescription: "Dominate Amazon search results and outperform competitors with <strong style='color:#a500fd'>expert Amazon Ads management</strong> that drives sales and profitability.",
  stats: [
  ...
  services: [
    ...
    { icon: "", title: "Sponsored Brands", desc: "Brand-level ads with logo, headline, and multiple products." },
    { icon: "", title: "Sponsored Display", desc: "Retargeting ads on and off Amazon to re-engage shoppers." },
