...
const FacebookAdsPage = () => <ServicePageTemplate config={{
  ...
  heroDescription: "Reach 3 billion users with <strong style='color:#a500fd'>precision-targeted Facebook campaigns</strong> that drive awareness, engagement, and conversions.",
  stats: [
  ...
  services: [
    ...
    { icon: "", title: "Facebook Shops", desc: "Catalog integration and dynamic product ads for e-commerce brands." },
  ],
  process: [
