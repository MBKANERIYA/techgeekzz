...
const config = {
  ...
  heroDescription: "Build credibility, earn media coverage, and manage your reputation with <strong style='color:#a500fd'>strategic PR campaigns</strong> that put your brand in the spotlight.",
  stats: [
  ...
  services: [
    ...
    { icon: "", title: "Press Release Writing", desc: "Compelling press releases that get picked up by major publications and news wires." },
    { icon: "", title: "Thought Leadership", desc: "Position your executives as industry experts through speaking, bylines, and interviews." },
    { icon: "", title: "Crisis Management", desc: "Rapid response protocols and strategic communication to protect your brand during crises." },
  ...
  whyUs: [
    ...
    { icon: "", title: "Crisis Ready", desc: "24/7 crisis communication support when your brand reputation is on the line." },
  ],
  faqs: [
