...
const config = {
  ...
  heroDescription: "Build a powerful social presence that drives engagement, grows your audience, and converts followers into loyal customers with <strong style='color:#a500fd'>data-driven strategies</strong>.",
  stats: [
  ...
  whyUs: [
    ...
    { icon: "", title: "No Lock-in Contracts", desc: "Flexible engagements with no lock-in contracts. Stay because of results, not contracts." },
  ],
  faqs: [
