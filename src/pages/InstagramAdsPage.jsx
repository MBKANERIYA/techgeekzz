...
const InstagramAdsPage = () => <ServicePageTemplate config={{
  ...
  heroDescription: "Captivate 2 billion users with <strong style='color:#c084fc'>visually stunning Instagram ads</strong> across Feed, Stories, Reels, and Explore.",
  stats: [
  ...
  services: [
    ...
    { icon: "🛍️", title: "Shopping Ads", desc: "Tag products directly in ads for seamless in-app purchasing." },
  ...
  whyUs: [
    ...
    { icon: "🛍️", title: "E-Commerce Focus", desc: "Instagram Shopping setup and optimization for direct sales." },
