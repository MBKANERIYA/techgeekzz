...
const faqs = [
  { q: 'What is Technical SEO?', a: 'Technical SEO focuses on optimizing your website infrastructure so search engines can efficiently crawl, index, and rank your pages. It covers site speed, mobile optimization, schema markup, URL structure, and more.' },
  { q: 'How does Technical SEO differ from On Page SEO?', a: 'Technical SEO deals with the underlying infrastructure and code of your website, while On Page SEO focuses on content and visible page elements. Both are essential for strong search rankings.' },
  { q: 'What are Core Web Vitals?', a: 'Core Web Vitals are Google metrics measuring page experience: Largest Contentful Paint (loading speed), First Input Delay (interactivity), and Cumulative Layout Shift (visual stability). We optimize all three.' },
  { q: 'How often should technical SEO be reviewed?', a: 'We recommend quarterly technical audits to catch new issues from site updates, plugin changes, or algorithm shifts. Continuous monitoring tools can also flag critical issues in real-time.' },
  { q: 'Can technical issues really impact rankings?', a: 'Absolutely. Slow page speed, broken redirects, crawl errors, and poor mobile experience can significantly hurt your rankings, even if your content and backlinks are excellent.' },
];
          ...
          <div className="row align-items-start g-5">
            ...
            <div className="col-lg-7">
              <h1 className="display-4 fw-bold text-white mb-4" style={{ lineHeight: 1.1, letterSpacing: '-1px' }}>
                <span className="hero-gradient-text">Technical SEO</span> Services
              </h1>

              <p className="text-secondary mb-4" style={{ maxWidth: 580, lineHeight: 1.8, fontSize: '1rem' }}>
                TechGeekz is one of the best SEO companies, offering expert services to boost your rankings, drive traffic, and grow your online presence. With our Technical SEO services, we promise the best conversion rates possible across all search platforms.
              </p>

              <p className="text-secondary mb-5" style={{ maxWidth: 580, lineHeight: 1.8, fontSize: '1rem' }}>
                As a leading <strong className="text-white">Technical SEO Company</strong>, TechGeekz brings together an innovation-led approach and search engine-friendly practices to help your website reach and be found by your target users. Our team of <strong className="text-white">Technical SEO Experts</strong> ensures that your business gains visibility and drives more customers and ultimately revenue.
              </p>
                  ...
                  <form onSubmit={handleSubmit} className="p-4 p-lg-4">
                    ...
                    <div className="mb-4">
                      ...
                      >
                        ...
                        <option value="technical-seo" style={{ background: '#1a1a2e' }}>Technical SEO Services</option>
          ...
          <div className="row align-items-center g-5 pt-4">
            ...
            <div className="col-lg-5">
              <div className="rounded-4 p-4 text-center" style={{ background: 'rgba(165,0,253,0.03)' }}>
                <img src="/images/technical-seo-illustration.png" alt="Technical SEO Services Illustration" className="img-fluid" style={{ maxHeight: 380 }} />
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="text-center mb-5 pt-4">
            <h2 className="display-6 fw-bold text-white" style={{ letterSpacing: '-1px' }}>
              Advantages of our <span className="hero-gradient-text fst-italic">Technical SEO services</span>
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: 'With the help of our Technical SEO services for small business, your website will rank higher and receive more visitors from search performance. People rarely care to look at Google\'s second-page results, so if your website is on the first page, you will receive clicks and your website will gain more visibility.',
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#a500fd" strokeWidth="1.5">
                ...
                desc: 'Our Technical SEO strategies target customers who are actively searching for services in your area. By optimizing your Google Business Profile and local listings, we connect your business directly with high-intent local buyers ready to convert.',
              },
              {
                icon: (
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#a500fd" strokeWidth="1.5">
                ...
                desc: 'Technical SEO drives highly targeted traffic that converts at a much higher rate. When customers find your business at the top of local results, they are more likely to call, visit, or make a purchase — directly boosting your revenue and ROI.',
              },
            ].map((card, i) => (
