...
const config = {
  title: "Technical SEO", icon: "⚙️", badge: "Technical SEO Services", glowColor: "rgba(99,102,241,1)",
  heroImage: '/images/heroes/hero-seo.png',
  heroTitle: "Build a Bulletproof", heroHighlight: "Technical Foundation.",
  heroDescription: "Fix crawlability issues, boost site speed, and ensure search engines can <strong style='color:#c084fc'>perfectly index</strong> every important page on your site.",
  stats: [
  ...
  services: [
    ...
    { icon: "🕷️", title: "Crawl Optimization", desc: "Fix crawl budget waste, broken links, redirect chains, and orphan pages." },
    ...
    { icon: "🏗️", title: "Site Architecture", desc: "URL structure, internal linking, silo architecture, and XML sitemaps." },
  ],
  process: [
  ...
  whyUs: [
    ...
    { icon: "🕷️", title: "Crawl Efficiency", desc: "Maximize crawl budget so Google indexes your important pages faster." },
