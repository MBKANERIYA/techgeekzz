...
const UIUXDesignPage = () => <ServicePageTemplate config={{
  ...
  heroDescription: "Create intuitive, delightful <strong style='color:#a500fd'>digital experiences</strong> that users love and that drive measurable business outcomes.",
  stats: [
  ...
  services: [
    ...
    { icon: "", title: "Information Architecture", desc: "Site maps, user flows, and content hierarchy for intuitive navigation." },
